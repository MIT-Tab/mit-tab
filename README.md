...
A more comprehensive guide to setting up your development environment on Windows can be found **[here](WINDOWS-DEVELOPMENT.md)**. This should provide an in-depth outline for other operating systems as well, although specific commands will vary.
