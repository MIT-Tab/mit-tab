...
def backup_round(dst_filename = None, round_number = None, btime = None):
    ...
    __log.debug("Trying to backup to backups directory")
...
def handle_backup(f):
    ...
    __log.debug("Tried to write %s", dst_filename)
    try:
