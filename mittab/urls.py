...
urlpatterns = [
    ...
    url(r'^judge/(\d+)/scratches/add/(\d+)/', judge_views.add_scratches, name='judge_add_scratch'),
    url(r'^judge/(\d+)/scratches/view/', judge_views.view_scratches, name='judge_view_scratches'),
    ...
    # Scratch related
    url(r'^judge/(\d+)/scratches/delete/(\d+)/', views.delete_scratch, name='judge_delete_scratch'),
    url(r'^team/(\d+)/scratches/delete/(\d+)/', views.delete_scratch, name='team_delete_scratch'),
    ...
    url(r'^team/(\d+)/scratches/add/(\d+)/', team_views.add_scratches, name='team_add_scratches'),
    url(r'^team/(\d+)/scratches/view/', team_views.view_scratches, name='team_view_scratches'),
    ...
    url(r'^team/card/(\d+)/pretty/$', team_views.pretty_tab_card, name='pretty_tab_card'),
    ...
    url(r'^debater/(\d+)/delete/$', debater_views.delete_debater, name='delete_debater'),
    ...
    url(r'^debater/ranking/$', debater_views.rank_debaters_ajax, name='rank_debaters_ajax'),
    ...
    url(r'^pairing/confirm_start_tourny/$', pairing_views.confirm_start_new_tourny, name='confirm_start_new_tourny'),
    ...
    url(r'^pairing/view_backups/$', pairing_views.view_backups, name='view_backups'),
