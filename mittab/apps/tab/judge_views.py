...
def add_scratches(request, judge_id, number_scratches):
    ...
    if request.method == "POST":
        ...
        initial_data = {"judge": judge_id, "scratch_type": 0}
