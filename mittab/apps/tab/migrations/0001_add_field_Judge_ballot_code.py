...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'tab.judge': {
            ...
            'ballot_code': ('django.db.models.fields.CharField', [], {'max_length': '6', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '30'}),
            'phone': ('localflavor.us.models.PhoneNumberField', [], {'max_length': '20', 'blank': 'True'}),
            'provider': ('django.db.models.fields.CharField', [], {'max_length': '40', 'blank': 'True'}),
            ...
            'schools': (
            'django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['tab.School']", 'symmetrical': 'False'})
        },
        u'tab.noshow': {
        ...
        u'tab.round': {
            ...
            'chair': ('django.db.models.fields.related.ForeignKey', [],
                      {'blank': 'True', 'related_name': "'chair'", 'null': 'True', 'to': u"orm['tab.Judge']"}),
            'gov_team': (
            'django.db.models.fields.related.ForeignKey', [], {'related_name': "'gov_team'", 'to': u"orm['tab.Team']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'judges': ('django.db.models.fields.related.ManyToManyField', [],
                       {'blank': 'True', 'related_name': "'judges'", 'null': 'True', 'symmetrical': 'False',
                        'to': u"orm['tab.Judge']"}),
            'opp_team': (
            'django.db.models.fields.related.ForeignKey', [], {'related_name': "'opp_team'", 'to': u"orm['tab.Team']"}),
        ...
        u'tab.team': {
            ...
            'debaters': ('django.db.models.fields.related.ManyToManyField', [],
                         {'to': u"orm['tab.Debater']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '30'}),
