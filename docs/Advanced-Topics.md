...
+---------------------+---------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| `var_to_nov`        | `2`           | The quotient of the number of teams in the varsity outround and the number of teams in the novice outround that are happening concurrently.  ie, if varsity octofinals (16 teams) were happening at the same time as novice semifinals (4 teams), this value would be 4.  This is to prevent judges / rooms from being paired in to outrounds occuring at the same time|
+---------------------+---------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
```
