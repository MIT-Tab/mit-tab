...
+--------------------------+---------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| `novice_outrounds_start_at` | `16`          | Select the varsity bracket size that runs alongside the first novice outround.  MIT Tab combines this with `nov_teams_to_break` to keep outround schedules aligned and prevent double booking.  Legacy installations that rely on `var_to_nov` continue to be respected, but this setting is now preferred.                                                               |
+--------------------------+---------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
