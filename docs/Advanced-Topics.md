...
+---------------------+---------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| `first_novice_outround_matches_varsity` | `16` | Which varsity outround runs concurrently with the first novice outround (novice finals). For example, if novice finals happen when varsity quarterfinals happen, select 8. If novice finals happen when varsity octofinals happen, select 16. Valid values: 32 (Triple Octos), 16 (Octos), 8 (Quarters), 4 (Semis), 2 (Finals)                                   |
+---------------------+---------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
